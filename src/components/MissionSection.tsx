    ...
    <section id="mission" className="py-20 md:py-32 relative overflow-hidden">
      <div className="container mx-auto px-4" ref={ref}>
        ...
        <motion.div
          ...
          className="mt-12 md:mt-16 glass p-6 md:p-8 lg:p-12 rounded-3xl glow-purple"
        >
          <div className="max-w-3xl mx-auto text-center">
            <h3 className="text-xl sm:text-2xl md:text-3xl lg:text-4xl font-bold mb-3 md:mb-4 gradient-text">
